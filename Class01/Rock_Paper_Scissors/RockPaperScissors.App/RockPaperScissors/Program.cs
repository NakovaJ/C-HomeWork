using System;
using RokPaperScissorsClassLibrary.Services;
...
namespace RockPaperScissors
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            List<int> points = new List<int>() { usersPoints,computerPoints};

            for (; ; )
            {
                Console.Clear();
                Console.WriteLine();
                Console.WriteLine("Welcome to this awesome Rock-Paper-Scissors App!");
                Console.WriteLine();
                ...
                {
                    case "1":
                        points=GameService.PlayGame(points);
                        break;
                    case "2":
                        GameService.Stats(points);
                        break;
                }
